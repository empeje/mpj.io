        ...
        [ ul []
            ...
            , li []
                [ div [ class "dropdown" ]
                    ...
                    , div [ class "dropdown-content" ]
                        [ a [ href "/hire-me" ] [ text "Hire Me" ]
                        , a [ href "/entrepreneurship" ] [ text "Entrepreneurship" ]
    ...
    div [ class "footer" ]
        [ div [ class "footer-content" ]
            ...
            , div [ class "footer-quick-links" ]
                ...
                , a [ href "/appearances", class "footer-link" ] [ text "Appearances" ]
                , a [ href "/entrepreneurship", class "footer-link" ] [ text "Investments" ]
                , a [ href "/offers", class "footer-link" ] [ text "Offers" ]
                ]
            , div [ class "footer-quick-links" ]
                [ Html.h3 [] [ text "Community" ]
                , linkNewTab [ hrefWithUtmSource "https://discord.com/invite/TEAJHURh2e", class "footer-link" ] [ text "Private Community" ]
                , linkNewTab [ hrefWithUtmSource "https://lu.ma/u/mpj", class "footer-link" ] [ text "Lu.ma" ]
                , linkNewTab [ hrefWithUtmSource "https://www.meetup.com/members/279285007/", class "footer-link" ] [ text "Meetup" ]
                ]
            ]
        ]
